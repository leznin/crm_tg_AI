  ...
  <div className="rounded-lg p-6 bg-surface-100/60 border border-white/5 shadow-elevated-sm">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="mt-2 p-2 rounded bg-blue-500/10 border border-blue-500/20">
              <p className="text-[10px] text-blue-300">
                <strong>Формат ответа:</strong> AI должен отвечать ТОЛЬКО в чистом JSON формате (без markdown ```json). Поля: summary, key_points[], sentiment
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2 p-2 rounded bg-blue-500/10 border border-blue-500/20">
              <p className="text-[10px] text-blue-300">
                <strong>Формат ответа:</strong> AI должен отвечать в чистом JSON формате с полем "suggestions" (массив строк). Не использовать markdown.
              </p>
            </div>
          </div>
...
Учитывай роль бизнес-аккаунта и специфику общения с клиентами.`,
              analysis: 'Проанализируй настроение собеседника и дай рекомендации по дальнейшему общению.' }); }} className="px-6 py-2 rounded-lg bg-surface-100/60 border border-white/5 text-gray-300 text-sm hover:bg-surface-100/80 transition-colors">
